...
val mockOrdersList = listOf(
    Order(
        ...
        notes = "Ring doorbell please", paymentMethod = "cod",
        items = listOf(OrderItem("1", "Royal Red Roses", 27.500, 2, "Roses"), OrderItem("5", "Golden Gift Box", 37.000, 1, "Gifts")),
        subtotal = 92.000, deliveryFee = 1.500, total = 93.500, status = "delivered", createdAt = "2026-05-20 14:30"
    ),
    Order(
        id = "ord-2", orderNumber = "HAV-5103", customerName = "Ahmed Hassan",
        phone = "+965 6234 5678",
        deliveryAddress = DeliveryAddress(
        ...
        items = listOf(OrderItem("9", "Peony Premium Box", 42.000, 1, "Bouquets")),
        subtotal = 42.000, deliveryFee = 1.500, total = 43.500, status = "out_for_delivery", createdAt = "2026-05-22 10:15"
    ),
    Order(
        id = "ord-3", orderNumber = "HAV-5210", customerName = "Sara Al-Ali",
        phone = "+965 9345 6789",
        deliveryAddress = DeliveryAddress(
        ...
        notes = "Leave at the gate", paymentMethod = "cod",
        items = listOf(OrderItem("3", "Pink Blush Arrangement", 23.000, 1, "Arrangements"), OrderItem("8", "Mini Rose Plant", 14.000, 2, "Plants")),
        subtotal = 51.000, deliveryFee = 1.500, total = 52.500, status = "preparing", createdAt = "2026-05-23 09:00"
    ),
    Order(
        id = "ord-4", orderNumber = "HAV-5345", customerName = "Mohammed Jassim",
        phone = "+965 5456 7890",
        deliveryAddress = DeliveryAddress(
            fullAddress = "Hawalli, Ibn Khaldun St, Hawalli Governorate, Kuwait",
            area = "Hawalli",
            block = "3",
            street = "Ibn Khaldun St",
            building = "11",
            floor = "4",
            latitude = 29.2922,
            longitude = 48.0089
        ...
        notes = "", paymentMethod = "cod",
        items = listOf(OrderItem("11", "Romance Bundle", 30.000, 1, "Gifts")),
        subtotal = 30.000, deliveryFee = 1.500, total = 31.500, status = "confirmed", createdAt = "2026-05-23 11:30"
    ),
    Order(
        id = "ord-5", orderNumber = "HAV-5402", customerName = "Noor Al-Din",
        phone = "+965 8567 8901",
        deliveryAddress = DeliveryAddress(
        ...
        notes = "Call before delivery", paymentMethod = "cod",
        items = listOf(OrderItem("2", "Sunset Bouquet", 20.000, 1, "Bouquets"), OrderItem("12", "Daisy Delight", 10.000, 3, "Bouquets")),
        subtotal = 50.000, deliveryFee = 1.500, total = 51.500, status = "pending", createdAt = "2026-05-23 12:45"
    ),
    Order(
        id = "ord-6", orderNumber = "HAV-5520", customerName = "Layla Abbas",
        phone = "+965 6678 9012",
        deliveryAddress = DeliveryAddress(
        ...
        notes = "", paymentMethod = "cod",
        items = listOf(OrderItem("6", "White Elegance", 29.000, 1, "Arrangements")),
        subtotal = 29.000, deliveryFee = 1.500, total = 30.500, status = "cancelled", createdAt = "2026-05-21 16:00"
    ),
)
